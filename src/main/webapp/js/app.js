(function() {
  ...
  app.controller('NavigationController', ['$scope', '$http',
    ...
    $scope.resetWindow = function() {
      $scope.coverImgUrl  = 'images/loading.gif';
      $scope.playlistTitle = '';
      $scope.songs = [];
    };
    ...
    $scope.showWindow = function(url){
      ...
      $http.get(url).success(function(data) {
          ...
          $scope.coverImgUrl = data.info.coverImgUrl;
          $scope.playlistTitle = data.info.title;
          $scope.listId = data.info.listId;
    ...
    $scope.showPlaylist = function(listId) {
      var url = '/playlist?list_id=' + listId;
  ...
  app.directive('openSongSource', ['angularPlayer', '$window',
    function (angularPlayer, $window) {
      return {
          ...
          link: function (scope, element, attrs) {
              element.bind('click', function (event) {
                $window.open(scope.song.sourceUrl, '_blank');
              });
          }
      };
  }]);
